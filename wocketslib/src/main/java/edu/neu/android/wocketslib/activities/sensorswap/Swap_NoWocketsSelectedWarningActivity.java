...
public class Swap_NoWocketsSelectedWarningActivity extends BaseActivity {
	private static final String TAG = "Swap_NoWocketsSelectedWarningActivity"; 
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.swap_nowocketswornwarning_activity);
		...
		text = this.getString(R.string.pagenineteenpart1) + num + this.getString(R.string.pagenineteenpart2);
		tv.setText(text);
