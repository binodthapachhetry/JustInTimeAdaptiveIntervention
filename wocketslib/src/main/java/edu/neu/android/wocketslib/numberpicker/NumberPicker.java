...
package edu.neu.android.wocketslib.numberpicker;
...
public class NumberPicker extends LinearLayout implements OnClickListener, OnFocusChangeListener, OnLongClickListener {
	...
	/**
	 * To prevent soft keyboard from popping up, call this method passing false
	 * for enabled
	 * 
	 * @param enabled
	 *            false to prevent soft keyboard from popping up
	 */
	public void setTextFocusable(boolean enabled) {
	...
	protected void updateView() {
		...
		if (mDisplayedValues == null) {
			...
			if (((mCurrent - mStart) < 0) || ((mCurrent - mStart) >= mDisplayedValues.length))
				Log.e(TAG, "Error: array value out of range: " + mCurrent + " " + mStart + " " + (mCurrent - mStart));
			else
	...
	private class NumberRangeKeyListener extends NumberKeyListener {
		...
		// TODO This doesn't allow for range limits when controlled by a soft
		// input method!
