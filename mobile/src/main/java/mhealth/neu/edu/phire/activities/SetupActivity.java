...
//import edu.neu.mhealth.android.wockets.phone.data.MATCHDataManager;
//import edu.neu.mhealth.android.wockets.phone.services.SurveyService;
...
//            @Override
//            public void run() {
//                DataManager.setActivePromptKey(mContext, MATCHConstants.KEY_EMA_DEMO);
...
//        emaTimePicker.putExtra("answerString", DataManager.getWakeTime(mContext, MATCHConstants.DEFAULT_WAKE_TIME));
...
//        Intent emaTimePicker = new Intent(this, EMATimePickerActivity.class);
//        emaTimePicker.putExtra("questionJson", ObjectMapper.serialize(question));
//        emaTimePicker.putExtra("answerString", DataManager.getSleepTime(mContext, MATCHConstants.DEFAULT_SLEEP_TIME));
//        startActivity(emaTimePicker);
//    }

//    @OnClick(R.id.activity_setup_start_saliva_demo)
//    public void onClickStartSalivaDemo() {
//        Timer timer = new Timer();
//        timer.schedule(new TimerTask() {
//            @Override
//            public void run() {
//                DataManager.setActivePromptKey(mContext, MATCHConstants.KEY_SALIVA_WAKING_DEMO);
//                DataManager.setActivePromptStartTime(mContext, DateTime.getCurrentTimeInMillis());
//                startService(new Intent(mContext, SurveyService.class));
//            }
//        }, DateTime.SECONDS_10_IN_MILLIS);
...
//        int salivaSurveyPromptedCount = MATCHDataManager.getSalivaSurveyPromptedCount(mContext);
//        int salivaSurveyCompletedCount = MATCHDataManager.getSalivaSurveyCompletedCount(mContext);
//
